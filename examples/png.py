...
class png(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "png")
        ...
        self.ofdm_testbed_image_vector_source_0 = ofdm_testbed.image_vector_source('/home/minh/SDR_NC/2 Nodes/2_P2P_Img/lena_gray_512.txt', 512*512, 1024, True, 0, 1)
...
def main(top_block_cls=png, options=None):
