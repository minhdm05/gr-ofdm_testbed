...
class ofdm(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "ofdm_simulation", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("ofdm_simulation")
        ...
        self.soapy_bladerf_source_0.set_bandwidth(0, 1.5e6)
        ...
        self.digital_ofdm_rx_0 = digital.ofdm_rx(
            ...
            debug_log=True,
            scramble_bits=True)
        self._delay_val_range = Range(0, 200, 1, 0, 200)
        ...
        self.connect((self.digital_ofdm_rx_0, 0), (self.show_text_0, 0))
